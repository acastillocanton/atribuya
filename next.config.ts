...
const INDEXABLE_PATHS_NEGATIVE_LOOKAHEAD =
  "/((?!$|en$|en/terms$|en/privacy$|en/cookies$|terminos$|privacidad$|cookies$|producto$|precios$|casos$|demo$|como-funciona$|en/product$|en/pricing$|en/case-studies$|en/demo$|en/how-it-works$|recursos/plantilla-atribucion-resenas$|recursos/plantillas-respuesta-resenas$|blog$|blog/.*|en/blog$|en/blog/.*|sitemap\\.xml$|robots\\.txt$|llms\\.txt$).*)";
