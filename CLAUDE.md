...
- `locations` — 2 fichas conectadas por **Vía B (OAuth)**: "Castillo Cantón - Consultor SEO Castellón" (0 reseñas en Google) y **"Mon Petit Caprice"** (7 reseñas).
- `reviews` — **7 filas reales** (`source='business_profile'`, todas las de Mon Petit). Los duplicados `places_api` de la transición se borraron a mano.
