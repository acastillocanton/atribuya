...
En orden: ~~Brevo SMTP~~ (✅ 2026-06-06) → ~~Google Cloud Places (Vía A)~~ (✅ 2026-06-07) → ~~DPA~~ (✅ 2026-06-07) → ~~OAuth Business Profile (Vía B)~~ (✅ **VERIFICADA E2E 2026-07-30**: 7/7 reseñas + alerta 1★). Para clientes externos falta **publicar el consent screen** (en Testing solo test users). **No queda ningún bloqueante técnico** para el primer cliente; lo demás de §8 son decisiones de negocio.
