...
- **🟡 pendientes de la revisión por buyer persona (2026-07-04)** — impacto medio, no bloqueantes (detalle → handoff §22):
  ...
  - Cita/testimonio **nominal** en `/casos` cuando se firme el permiso comercial (hoy el caso es anónimo).
  - Primer **artículo real del blog** (el proyecto Sanity está activo y vacío).
