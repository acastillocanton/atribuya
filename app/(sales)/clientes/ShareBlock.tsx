...
import { buildShareUrl, buildShareDisplay } from "@/lib/share-link";

export type ShareBlockProps = {
  appBase: string;
  /** Slug of the sales' org — required for the path-prefix landing URL. */
  orgSlug: string;
  salesName: string;
  salesSlug: string;
  clientName: string;
...
export function ShareBlock({
  ...
  const fullUrl = buildShareUrl(appBase, orgSlug, salesSlug, clientSlug);
  const displayUrl = buildShareDisplay(appBase, orgSlug, salesSlug, clientSlug);
