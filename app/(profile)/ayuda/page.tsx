...
export const metadata = { title: "Ayuda · Atribuya" };
...
export default function AyudaPage() {
  return (
    <>
      <Topbar
        title="Ayuda"
        subtitle="Cómo usar Atribuya paso a paso"
        breadcrumb="Atribuya"
        range={null}
      />
      ...
      >
        ...
        <main style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          <section id="bienvenida">
            <h2 style={h2Style}>1. Bienvenida a Atribuya</h2>
            <p style={pStyle}>
              Atribuya es la plataforma interna de{" "}
              <strong>Atribuya</strong> donde cada comercial
          ...
          <section id="login">
            ...
            <ol style={olStyle}>
              ...
              <li>Haz clic en el botón <strong>&ldquo;Acceder a Atribuya&rdquo;</strong>.</li>
