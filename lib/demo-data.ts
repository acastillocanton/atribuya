...
export const TEAM: DemoPerson[] = [
  ...
  },
  {
    ...
    name: "Lucía Vega",
    role: "Senior Sales",
    branch: "Beta Apartamentos · Centro",
    team: "Levante",
    reviews: 71,
    sent: 88,
    avg: 4.9,
...
export const RECENT: DemoRecent[] = [
  {
    ...
    stars: 5,
    sales: "Carla Ruiz",
    text: "Visita a Acme Promotora Centro impecable. Carla nos explicó cada detalle del plano y los acabados.",
    verified: true,
  },
  {
    id: "r2",
...
export const BRANCHES = [
  { name: "Acme Promotora · Centro", reviews: 142, conv: "82%", stars: "4,9", dev: "+14%" },
  { name: "Acme Promotora · Norte", reviews: 128, conv: "76%", stars: "4,7", dev: "+9%" },
  { name: "Beta Apartamentos · Centro", reviews: 112, conv: "81%", stars: "4,8", dev: "+11%" },
  { name: "Beta Apartamentos · Norte", reviews: 77, conv: "70%", stars: "4,6", dev: "+3%" },
];
