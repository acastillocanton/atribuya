...
export async function notifyNewReview(input: NewReviewNotificationInput) {
  ...
  const subject = `${ratingStars(input.rating)} Nueva reseña atribuida en Atribuya`;
...
function renderText(
  ...
  return [
    `Hola, ${firstName}.`,
    "",
    `Acabas de recibir una nueva reseña atribuida en Atribuya.`,
    "",
    ...
    <tr><td align="center" style="padding:48px 16px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" style="width:560px;max-width:100%;">
        <tr><td style="padding:0 8px 28px 8px;">
          ...
          <div style="margin-top:18px;font-size:12px;letter-spacing:0.12em;text-transform:uppercase;color:#8a8478;font-weight:600;">Atribuya · Notificación</div>
        </td></tr>
        ...
        <tr><td style="padding:24px 8px 0 8px;font-size:11.5px;line-height:1.6;color:#a8a294;">
          Recibes este correo porque eres comercial activo en Atribuya.
          <br><br>
          Atribuya · Atribuya
        </td></tr>
      </table>
